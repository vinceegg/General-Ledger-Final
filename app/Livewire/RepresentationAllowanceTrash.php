...
class RepresentationAllowanceTrash extends Component
{
    ...
    {
        $this->softDeletedData =RepresentationAllowanceModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = RepresentationAllowanceModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('RepresentationAllowanceArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.representation-allowance-trash', [
