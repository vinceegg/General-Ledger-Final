...
class RetirementandLifeInsurancePremiumsShow extends Component
{
    ...
    {       
        ...
        RetirementandLifeInsurancePremiumsModel::create($validatedData);
    ...
    {
        $general_ledger = RetirementandLifeInsurancePremiumsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        RetirementandLifeInsurancePremiumsModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new RetirementandLifeInsurancePremiumsImport, $filePath);

        return redirect()->route('RetirementandLifeInsurancePremiums')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new RetirementandLifeInsurancePremiumsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new RetirementandLifeInsurancePremiumsExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = RetirementandLifeInsurancePremiumsModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $query = RetirementandLifeInsurancePremiumsModel::query();
        ...
        return view('livewire.retirementand-life-insurance-premiums-show',['general_ledger' => $general_ledger]);
    }
}
