...
class TechnicalandScientificEquipmentShow extends Component
{
    ...
    {       
        ...
        TechnicalandScientificEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = TechnicalandScientificEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        TechnicalandScientificEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new TechnicalandScientificEquipmentImport, $filePath);
    ...
    {
        return Excel::download(new TechnicalandScientificEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new TechnicalandScientificEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = TechnicalandScientificEquipmentModel::query();
        ...
        $technical_and_scientific_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.technicaland-scientific-equipment-show',['general_ledger' => $technical_and_scientific_equipment]);
    }
}
