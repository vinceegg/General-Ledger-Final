...
class YearEndBonusTrash extends Component
{
    ...
    {
        $this->softDeletedData =YearEndBonusModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = YearEndBonusModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('YearEndBonusArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.year-end-bonus-trash', [
