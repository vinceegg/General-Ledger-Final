...
class InterestIncomeTrash extends Component
{
    ...
    {
        $this->softDeletedData = InterestIncomeModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = InterestIncomeModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = InterestIncomeModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('InterestIncomeArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.interest-income-trash', [
