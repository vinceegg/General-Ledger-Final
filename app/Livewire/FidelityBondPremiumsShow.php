...
class FidelityBondPremiumsShow extends Component
{
    ...
    {       
        ...
        FidelityBondPremiumsModel::create($validatedData);
    ...
    {
        $general_ledger = FidelityBondPremiumsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        FidelityBondPremiumsModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new FidelityBondPremiumsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new FidelityBondPremiumsExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = FidelityBondPremiumsModel::query();
        ...
        $fidelity_bond_premiums = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.fidelity-bond-premiums-show',['general_ledger' => $fidelity_bond_premiums]);
    }
}
