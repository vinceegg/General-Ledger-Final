...
class PhilHealthContributionsTrash extends Component
{
    ...
    {
        $this->softDeletedData = PhilHealthContributionsModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = PhilHealthContributionsModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('PhilHealthContributionsArchived')->with('message', 'Deleted Successfully');
    }
