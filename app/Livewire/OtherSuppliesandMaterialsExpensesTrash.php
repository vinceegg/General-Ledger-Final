...
class OtherSuppliesandMaterialsExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = OtherSuppliesandMaterialsExpensesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OtherSuppliesandMaterialsExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OtherSuppliesandMaterialsExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OtherSuppliesandMaterialsExpensesArchived')->with('message', 'Deleted Successfully');
    }
