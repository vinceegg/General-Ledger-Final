...
class DepreciationTransportationEquipmentShow extends Component
{
    ...
    {       
        ...
        DepreciationTransportationEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = DepreciationTransportationEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        DepreciationTransportationEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new DepreciationTransportationEquipmentImport, $filePath);

        return redirect()->route('DepreciationTransportationEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new DepreciationTransportationEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DepreciationTransportationEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DepreciationTransportationEquipmentModel::query();
        ...
        $depreciation_transportation_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.depreciation-transportation-equipment-show',['general_ledger' => $depreciation_transportation_equipment]);
    }
}
