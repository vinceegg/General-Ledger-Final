...
class ElectricityExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = ElectricityExpensesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = ElectricityExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = ElectricityExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('ElectricityExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.electricity-expenses-trash', [
