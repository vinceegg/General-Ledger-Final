...
class AccDepreciationOtherMachineryEquipmentShow extends Component
{
    ...
    {       
        ...
        AccDepreciationOtherMachineryEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = AccDepreciationOtherMachineryEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccDepreciationOtherMachineryEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new AccDepreciationOtherMachineryEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccDepreciationOtherMachineryEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AccDepreciationOtherMachineryEquipmentModel::query();
        ...
        $acc_depreciation_other_machinery_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.acc-depreciation-other-machinery-equipment-show',['general_ledger' => $acc_depreciation_other_machinery_equipment]);
    }
}
