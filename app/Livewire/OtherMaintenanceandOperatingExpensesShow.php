...
class OtherMaintenanceandOperatingExpensesShow extends Component
{
    ...
    {       
        ...
        OtherMaintenanceandOperatingExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = OtherMaintenanceandOperatingExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherMaintenanceandOperatingExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new OtherMaintenanceandOperatingExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherMaintenanceandOperatingExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherMaintenanceandOperatingExpensesModel::query();
        ...
        $other_maintenance_and_operating_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-maintenanceand-operating-expenses-show',['general_ledger' => $other_maintenance_and_operating_expenses]);
    }
}
