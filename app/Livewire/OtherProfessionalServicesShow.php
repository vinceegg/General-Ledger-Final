...
class OtherProfessionalServicesShow extends Component
{
    ...
    {       
        ...
        OtherProfessionalServicesModel::create($validatedData);
    ...
    {
        $general_ledger = OtherProfessionalServicesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherProfessionalServicesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new OtherProfessionalServicesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherProfessionalServicesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherProfessionalServicesModel::query();
        ...
        $other_professional_services = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-professional-services-show',['general_ledger' => $other_professional_services]);
    }
}
