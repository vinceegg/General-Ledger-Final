...
class MedicalEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =MedicalEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = MedicalEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = MedicalEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('MedicalEquipmentArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.medical-equipment-trash', [
