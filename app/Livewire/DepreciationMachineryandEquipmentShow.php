...
class DepreciationMachineryandEquipmentShow extends Component
{
    ...
    {       
        ...
        DepreciationMachineryandEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = DepreciationMachineryandEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        DepreciationMachineryandEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new DepreciationMachineryandEquipmentImport, $filePath);

        return redirect()->route('DepreciationMachineryandEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new DepreciationMachineryandEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DepreciationMachineryandEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DepreciationMachineryandEquipmentModel::query();
        ...
        $depreciation_machinery_and_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.depreciation-machineryand-equipment-show',['general_ledger' => $depreciation_machinery_and_equipment]);
    }
}
