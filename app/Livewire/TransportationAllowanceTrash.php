...
class TransportationAllowanceTrash extends Component
{
    ...
    {
        $this->softDeletedData =TransportationAllowanceModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = TransportationAllowanceModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('TransportationAllowanceArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.transportation-allowance-trash', [
