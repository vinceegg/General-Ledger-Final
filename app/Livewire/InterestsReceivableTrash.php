...
class InterestsReceivableTrash extends Component
{
    ...
    {
        $this->softDeletedData =InterestsReceivableModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = InterestsReceivableModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = InterestsReceivableModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('InterestsReceivableArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.interests-receivable-trash', [
