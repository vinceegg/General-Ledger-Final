...
class OtherMachineryEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =OtherMachineryEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OtherMachineryEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OtherMachineryEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OtherMachineryEquipmentArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.other-machinery-equipment-trash', [
