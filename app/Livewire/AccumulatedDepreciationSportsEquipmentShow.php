...
class AccumulatedDepreciationSportsEquipmentShow extends Component
{
    ...
    {       
        ...
        AccumulatedDepreciationSportsEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = AccumulatedDepreciationSportsEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccumulatedDepreciationSportsEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new AccumulatedDepreciationSportsEquipmentImport, $filePath);

        return redirect()->route('AccumulatedDepreciationSportsEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new AccumulatedDepreciationSportsEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccumulatedDepreciationSportsEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AccumulatedDepreciationSportsEquipmentModel::query();
        ...
        $accumulated_depreciation_sports_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.accumulated-depreciation-sports-equipment-show',['general_ledger' => $accumulated_depreciation_sports_equipment]);
    }
}
