...
class OfficeEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =OfficeEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OfficeEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OfficeEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OfficeEquipmentArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.office-equipment-trash', [
