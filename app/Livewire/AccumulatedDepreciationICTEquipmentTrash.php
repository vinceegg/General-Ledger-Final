...
class AccumulatedDepreciationICTEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =AccumulatedDepreciationICTEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = AccumulatedDepreciationICTEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = AccumulatedDepreciationICTEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('AccumulatedDepreciationICTEquipmentArchived')->with('message', 'Deleted Successfully');
    }
