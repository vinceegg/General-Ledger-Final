...
class TravelingExpensesLocalTrash extends Component
{
    ...
    {
        $this->softDeletedData = TravelingExpensesLocalModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = TravelingExpensesLocalModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('TravelingExpensesLocalArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.traveling-expenses-local-trash', [
