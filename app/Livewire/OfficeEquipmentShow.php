...
class OfficeEquipmentShow extends Component
{
    ...
    {       
        ...
        OfficeEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = OfficeEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OfficeEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new OfficeEquipmentImport, $filePath);

        return redirect()->route('OfficeEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new OfficeEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OfficeEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OfficeEquipmentModel::query();
        ...
        $office_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.office-equipment-show',['general_ledger' => $office_equipment]);
    }
}
