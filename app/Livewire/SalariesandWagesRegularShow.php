...
class SalariesandWagesRegularShow extends Component
{
    ...
    {       
        ...
        SalariesandWagesRegularModel::create($validatedData);
    ...
    {
        $general_ledger = SalariesandWagesRegularModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        SalariesandWagesRegularModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new SalariesandWagesRegularExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new SalariesandWagesRegularExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = SalariesandWagesRegularModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $query = SalariesandWagesRegularModel::query();
        ...
        return view('livewire.salariesand-wages-regular-show',['general_ledger' => $salaries_and_wages_regular]);
    }
}
