...
class PrintingandPublicationExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = PrintingandPublicationExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = PrintingandPublicationExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('PrintingandPublicationExpensesArchived')->with('message', 'Deleted Successfully');
    }
