...
class DuetoPAGIBIGShow extends Component
{
    ...
    {       
        ...
        DuetoPAGIBIGModel::create($validatedData);
    ...
    public function updateGeneralLedger()
    {
        ...
        DuetoPAGIBIGModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new DuetoPAGIBIGExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DuetoPAGIBIGExport, 'Ledger Sheet.csv');
    }
    ...
    public function render()
    {
        ...
        $due_to_pag_ibig = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.dueto-p-a-g-i-b-i-g-show',['general_ledger' => $due_to_pag_ibig]);
    }
}
