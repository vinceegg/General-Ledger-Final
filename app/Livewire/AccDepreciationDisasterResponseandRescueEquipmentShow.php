...
class AccDepreciationDisasterResponseandRescueEquipmentShow extends Component
{
    ...
    {       
        ...
        AccDepreciationDisasterResponseandRescueEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = AccDepreciationDisasterResponseandRescueEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccDepreciationDisasterResponseandRescueEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new AccDepreciationDisasterResponseandRescueEquipmentImport, $filePath);

        return redirect()->route('AccDepreciationDisasterResponseandRescueEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new AccDepreciationDisasterResponseandRescueEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccDepreciationDisasterResponseandRescueEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AccDepreciationDisasterResponseandRescueEquipmentModel::query();
        ...
        $acc_depreciation_disaster_response_and_rescue_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.acc-depreciation-disaster-responseand-rescue-equipment-show',['general_ledger' => $acc_depreciation_disaster_response_and_rescue_equipment]);
    }
}
