...
class TrustLiabilitiesTrash extends Component
{
    ...
    {
        $this->softDeletedData = TrustLiabilitiesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = TrustLiabilitiesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('TrustLiabilitiesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.trust-liabilities-trash', [
