...
class RepairsandMaintBuildingOtherStructuresShow extends Component
{
    ...
    {       
        ...
        RepairsandMaintBuildingOtherStructuresModel::create($validatedData);
    ...
    {
        $general_ledger = RepairsandMaintBuildingOtherStructuresModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        RepairsandMaintBuildingOtherStructuresModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new RepairsandMaintBuildingOtherStructuresExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new RepairsandMaintBuildingOtherStructuresExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = RepairsandMaintBuildingOtherStructuresModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $query = RepairsandMaintBuildingOtherStructuresModel::query();
        ...
        $repairs_and_maint_building_other_structures = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.repairsand-maint-building-other-structures-show',['general_ledger' => $repairs_and_maint_building_other_structures]);
    }
}
