...
class OtherPayablesTrash extends Component
{
    ...
    {
        $this->softDeletedData = OtherPayablesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OtherPayablesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OtherPayablesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OtherPayablesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.other-payables-trash', [
