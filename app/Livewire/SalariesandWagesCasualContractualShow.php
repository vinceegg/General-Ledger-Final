...
class SalariesandWagesCasualContractualShow extends Component
{
    ...
    {       
        ...
        SalariesandWagesCasualContractualModel::create($validatedData);
    ...
    {
        $general_ledger = SalariesandWagesCasualContractualModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        SalariesandWagesCasualContractualModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new SalariesandWagesCasualContractualImport, $filePath);
    ...
    {
        return Excel::download(new SalariesandWagesCasualContractualExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new SalariesandWagesCasualContractualExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = SalariesandWagesCasualContractualModel::query();
        ...
        $salaries_and_wages_regular = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.salariesand-wages-casual-contractual-show',['general_ledger' => $salaries_and_wages_regular]);
    }
}
