...
class DuetoPHILHEALTHTrash extends Component
{
    ...
    {
        $this->softDeletedData = DuetoPHILHEALTHModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DuetoPHILHEALTHModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DuetoPHILHEALTHModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DuetoPHILHEALTHArchived')->with('message', 'Deleted Successfully');
    }
