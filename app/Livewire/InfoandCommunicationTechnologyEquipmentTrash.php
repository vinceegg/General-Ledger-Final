...
class InfoandCommunicationTechnologyEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =InfoandCommunicationTechnologyEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = InfoandCommunicationTechnologyEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = InfoandCommunicationTechnologyEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('InfoandCommunicationTechnologyEquipmentArchived')->with('message', 'Deleted Successfully');
    }
