...
class WaterExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = WaterExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = WaterExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('WaterExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.water-expenses-trash', [
