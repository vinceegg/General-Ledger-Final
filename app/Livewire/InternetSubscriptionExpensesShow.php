...
class InternetSubscriptionExpensesShow extends Component
{
    ...
    {       
        ...
        InternetSubscriptionExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = InternetSubscriptionExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        InternetSubscriptionExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        $query = InternetSubscriptionExpensesModel::query();
