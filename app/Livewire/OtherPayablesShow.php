...
class OtherPayablesShow extends Component
{
    ...
    {       
        ...
        OtherPayablesModel::create($validatedData);
    ...
    {
        $general_ledger = OtherPayablesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherPayablesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new OtherPayablesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherPayablesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherPayablesModel::query();
        ...
        $other_payables = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-payables-show',['general_ledger' => $other_payables]);
    }
}
