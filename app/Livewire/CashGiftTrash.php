...
class CashGiftTrash extends Component
{
    ...
    {
        $this->softDeletedData =CashGiftModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = CashGiftModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = CashGiftModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('CashGiftArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.cash-gift-trash', [
