...
class MotorVehiclesShow extends Component
{
    ...
    {       
        ...
        MotorVehiclesModel::create($validatedData);
    ...
    {
        $general_ledger = MotorVehiclesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        MotorVehiclesModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new MotorVehiclesImport, $filePath);

        return redirect()->route('MotorVehicles')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new MotorVehiclesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new MotorVehiclesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = MotorVehiclesModel::query();
        ...
        $motor_vehicles = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.motor-vehicles-show',['general_ledger' => $motor_vehicles]);
    }
}
