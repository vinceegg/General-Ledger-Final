...
class RepairsandMaintTransportationEquipmentShow extends Component
{
    ...
    {       
        ...
        RepairsandMaintTransportationEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = RepairsandMaintTransportationEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        RepairsandMaintTransportationEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new RepairsandMaintTransportationEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new RepairsandMaintTransportationEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = RepairsandMaintTransportationEquipmentModel::query();
        ...
        $repairs_and_maint_transportation_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.repairsand-maint-transportation-equipment-show',['general_ledger' => $repairs_and_maint_transportation_equipment]);
    }
}
