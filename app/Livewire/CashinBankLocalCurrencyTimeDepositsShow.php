...
use App\Exports\CashinBankLocalCurrencyTimeDepositsExport;
use App\Imports\CashinBankLocalCurrencyTimeDepositsImport;
...
class CashinBankLocalCurrencyTimeDepositsShow extends Component
{
    ...
    {       
        ...
        CashinBankLocalCurrencyTimeDepositsModel::create($validatedData);
    ...
    {
        $general_ledger = CashinBankLocalCurrencyTimeDepositsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        CashinBankLocalCurrencyTimeDepositsModel::where('id', $this->general_ledger_id)->update([
    ...
    // Soft delete CashinBankLocalCurrencyTimeDeposits
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new CashinBankLocalCurrencyTimeDepositsImport, $filePath);

        return redirect()->route('CashinBankLocalCurrencyTimeDeposits')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new CashinBankLocalCurrencyTimeDepositsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new CashinBankLocalCurrencyTimeDepositsExport, 'Ledger Sheet.csv');
    }
    ...
    public function restoreCashinBankLocalCurrencyTimeDeposits($id)
    {
        $general_ledger = CashinBankLocalCurrencyTimeDepositsModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $query = CashinBankLocalCurrencyTimeDepositsModel::query();
        ...
        $cash_in_bank_local_currency_time_deposits = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.cash-in-bank-local-currency-time-deposits-show',['general_ledger' => $cash_in_bank_local_currency_time_deposits]);
    }
}