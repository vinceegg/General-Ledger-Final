...
class SportsEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =SportsEquipmentModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = SportsEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('SportsEquipmentArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.sports-equipment-trash', [
