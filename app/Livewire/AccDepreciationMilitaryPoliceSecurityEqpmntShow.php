...
class AccDepreciationMilitaryPoliceSecurityEqpmntShow extends Component
{
    ...
    {       
        ...
        AccDepreciationMilitaryPoliceSecurityEqpmntModel::create($validatedData);
    ...
    {
        $general_ledger = AccDepreciationMilitaryPoliceSecurityEqpmntModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccDepreciationMilitaryPoliceSecurityEqpmntModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new AccDepreciationMilitaryPoliceSecurityEqpmntExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccDepreciationMilitaryPoliceSecurityEqpmntExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AccDepreciationMilitaryPoliceSecurityEqpmntModel::query();
        ...
        $acc_depreciation_military_police_security_eqpmnt = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.acc-depreciation-military-police-security-eqpmnt-show',['general_ledger' => $acc_depreciation_military_police_security_eqpmnt]);
    }
}
