...
class AccumulatedDepreciationMedicalEquipmentShow extends Component
{
    ...
    {       
        ...
        AccumulatedDepreciationMedicalEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = AccumulatedDepreciationMedicalEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccumulatedDepreciationMedicalEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new AccumulatedDepreciationMedicalEquipmentImport, $filePath);

        return redirect()->route('AccumulatedDepreciationMedicalEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new AccumulatedDepreciationMedicalEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccumulatedDepreciationMedicalEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AccumulatedDepreciationMedicalEquipmentModel::query();
        ...
        $accumulated_depreciation_medical_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.accumulated-depreciation-medical-equipment-show',['general_ledger' => $accumulated_depreciation_medical_equipment]);
    }
}
