...
class GuarantySecurityDepositsPayableShow extends Component
{
    ...
    {       
        ...
        GuarantySecurityDepositsPayableModel::create($validatedData);
    ...
    {
        $general_ledger = GuarantySecurityDepositsPayableModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        GuarantySecurityDepositsPayableModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new GuarantySecurityDepositsPayableExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new GuarantySecurityDepositsPayableExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = GuarantySecurityDepositsPayableModel::query();
        ...
        $guaranty_security_deposits_payable = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.guaranty-security-deposits-payable-show',['general_ledger' => $guaranty_security_deposits_payable]);
    }
}
