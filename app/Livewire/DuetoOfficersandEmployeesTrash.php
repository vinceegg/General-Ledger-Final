...
class DuetoOfficersandEmployeesTrash extends Component
{
    ...
    {
        $this->softDeletedData = DuetoOfficersandEmployeesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DuetoOfficersandEmployeesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DuetoOfficersandEmployeesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DuetoOfficersandEmployeesArchived')->with('message', 'Deleted Successfully');
    }
