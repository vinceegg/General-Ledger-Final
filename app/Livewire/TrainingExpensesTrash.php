...
class TrainingExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = TrainingExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = TrainingExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('TrainingExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.training-expenses-trash', [
