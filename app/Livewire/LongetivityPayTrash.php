...
class LongetivityPayTrash extends Component
{
    ...
    {
        $this->softDeletedData =LongetivityPayModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = LongetivityPayModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = LongetivityPayModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('LongetivityPayArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.longetivity-pay-trash', [
