...
class RentExpensesShow extends Component
{
    ...
    {       
        ...
        RentExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = RentExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        RentExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new RentExpensesImport, $filePath);

        return redirect()->route('RentExpenses')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new RentExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new RentExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = RentExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    public function render()
    {
        ...
        $rent_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.rent-expenses-show',['general_ledger' => $rent_expenses]);
    }
}
