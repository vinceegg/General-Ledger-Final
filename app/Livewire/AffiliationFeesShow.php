...
class AffiliationFeesShow extends Component
{
    ...
    {       
        ...
        AffiliationFeesModel::create($validatedData);
    ...
    {
        $general_ledger = AffiliationFeesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AffiliationFeesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new AffiliationFeesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AffiliationFeesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AffiliationFeesModel::query();
        ...
        $affiliation_fees = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.affiliation-fees-show',['general_ledger' => $affiliation_fees]);
    }
}
