...
class DepreciationBuildingandStructuresShow extends Component
{
    ...
    {       
        ...
        DepreciationBuildingandStructuresModel::create($validatedData);
    ...
    {
        $general_ledger = DepreciationBuildingandStructuresModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        DepreciationBuildingandStructuresModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new DepreciationBuildingandStructuresExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DepreciationBuildingandStructuresExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DepreciationBuildingandStructuresModel::query();
        ...
        $depreciation_building_and_structures = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
