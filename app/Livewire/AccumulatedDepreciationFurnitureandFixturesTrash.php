...
class AccumulatedDepreciationFurnitureandFixturesTrash extends Component
{
    ...
    {
        $this->softDeletedData = AccumulatedDepreciationFurnitureandFixturesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = AccumulatedDepreciationFurnitureandFixturesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = AccumulatedDepreciationFurnitureandFixturesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('AccumulatedDepreciationFurnitureandFixturesArchived')->with('message', 'Deleted Successfully');
    }
