...
class OtherSuppliesandMaterialsExpensesShow extends Component
{
    ...
    {       
        ...
        OtherSuppliesandMaterialsExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = OtherSuppliesandMaterialsExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherSuppliesandMaterialsExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new OtherSuppliesandMaterialsExpensesImport, $filePath);

        return redirect()->route('OtherSuppliesandMaterialsExpenses')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new OtherSuppliesandMaterialsExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherSuppliesandMaterialsExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherSuppliesandMaterialsExpensesModel::query();
        ...
        $other_supplies_and_materials_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-suppliesand-materials-expenses-show',['general_ledger' => $other_supplies_and_materials_expenses]);
    }
}
