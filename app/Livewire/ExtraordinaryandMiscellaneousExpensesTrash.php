...
class ExtraordinaryandMiscellaneousExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = ExtraordinaryandMiscellaneousExpensesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = ExtraordinaryandMiscellaneousExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = ExtraordinaryandMiscellaneousExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('ExtraordinaryandMiscellaneousExpensesArchived')->with('message', 'Deleted Successfully');
    }
