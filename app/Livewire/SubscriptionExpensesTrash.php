...
class SubscriptionExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = SubscriptionExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = SubscriptionExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('SubscriptionExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.subscription-expenses-trash', [
