...
class InsuranceExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = InsuranceExpensesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = InsuranceExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = InsuranceExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('InsuranceExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.insurance-expenses-trash', [
