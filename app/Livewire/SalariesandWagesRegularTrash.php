...
class SalariesandWagesRegularTrash extends Component
{
    ...
    {
        $this->softDeletedData =SalariesandWagesRegularModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = SalariesandWagesRegularModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('SalariesandWagesRegularArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.salaries-and-wages-regular-trash', [
