...
class DepreciationMachineryandEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData = DepreciationMachineryandEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DepreciationMachineryandEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DepreciationMachineryandEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DepreciationMachineryandEquipmentArchived')->with('message', 'Deleted Successfully');
    }
