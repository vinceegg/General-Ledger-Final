...
class DuetoPHILHEALTHShow extends Component
{
    ...
    {       
        ...
        DuetoPHILHEALTHModel::create($validatedData);
    ...
    public function updateGeneralLedger()
    {
        ...
        DuetoPHILHEALTHModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new DuetoPHILHEALTHExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DuetoPHILHEALTHExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DuetoPHILHEALTHModel::query();
        ...
        $due_to_philhealth = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
