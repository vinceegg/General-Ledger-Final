...
class DepreciationFurnituresandBooksTrash extends Component
{
    ...
    {
        $this->softDeletedData = DepreciationFurnituresandBooksModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DepreciationFurnituresandBooksModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DepreciationFurnituresandBooksModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DepreciationFurnituresandBooksArchived')->with('message', 'Deleted Successfully');
    }
