...
class OtherDeferredCreditsShow extends Component
{
    ...
    {       
        ...
        OtherDeferredCreditsModel::create($validatedData);
    ...
    {
        $general_ledger = OtherDeferredCreditsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherDeferredCreditsModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new OtherDeferredCreditsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherDeferredCreditsExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherDeferredCreditsModel::query();
        ...
        $other_deferred_credits = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-deferred-credits-show',['general_ledger' => $other_deferred_credits]);
    }
}
