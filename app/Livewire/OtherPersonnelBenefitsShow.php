...
class OtherPersonnelBenefitsShow extends Component
{
    ...
    {       
        ...
        OtherPersonnelBenefitsModel::create($validatedData);
    ...
    {
        $general_ledger = OtherPersonnelBenefitsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherPersonnelBenefitsModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new OtherPersonnelBenefitsImport, $filePath);

        return redirect()->route('OtherPersonnelBenefits')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new OtherPersonnelBenefitsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherPersonnelBenefitsExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherPersonnelBenefitsModel::query();
        ...
        $other_personnel_benefits = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-personnel-benefits-show',['general_ledger' => $other_personnel_benefits]);
    }
}
