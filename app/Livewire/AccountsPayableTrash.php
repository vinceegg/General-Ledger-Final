...
class AccountsPayableTrash extends Component
{
    ...
    {
        $this->softDeletedData = AccountsPayableModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = AccountsPayableModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = AccountsPayableModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('AccountsPayableArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.accounts-payable-trash', [
