...
use App\Imports\AccountsReceivableImport;
...
class AccountsReceivableShow extends Component
{
    use WithFileUploads;
    ...
    {       
        ...
        AccountsReceivableModel::create($validatedData);
    ...
    {
        $general_ledger = AccountsReceivableModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccountsReceivableModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new AccountsReceivableExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccountsReceivableExport, 'Ledger Sheet.csv');
    }
