...
class RentExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = RentExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = RentExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('RentExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.rent-expenses-trash', [
