...
class MedicalEquipmentShow extends Component
{
    ...
    {       
        ...
        MedicalEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = MedicalEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        MedicalEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new MedicalEquipmentImport, $filePath);
    ...
    {
        return Excel::download(new MedicalEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new MedicalEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = MedicalEquipmentModel::query();
        ...
        $medical_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.medical-equipment-show',['general_ledger' => $medical_equipment]);
    }
}
