...
class OtherMaintenanceandOperatingExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = OtherMaintenanceandOperatingExpensesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OtherMaintenanceandOperatingExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OtherMaintenanceandOperatingExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OtherMaintenanceandOperatingExpensesArchived')->with('message', 'Deleted Successfully');
    }
