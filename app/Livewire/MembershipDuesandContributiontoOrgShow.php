...
class MembershipDuesandContributiontoOrgShow extends Component
{
    ...
    {       
        ...
        MembershipDuesandContributiontoOrgModel::create($validatedData);
    ...
    {
        $general_ledger = MembershipDuesandContributiontoOrgModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        MembershipDuesandContributiontoOrgModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new MembershipDuesandContributiontoOrgImport, $filePath);

        return redirect()->route('MembershipDuesandContributiontoOrg')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new MembershipDuesandContributiontoOrgExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new MembershipDuesandContributiontoOrgExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = MembershipDuesandContributiontoOrgModel::query();
        ...
        $membership_dues_and_contribution_to_org = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.membership-duesand-contributionto-org-show',['general_ledger' => $membership_dues_and_contribution_to_org]);
    }
