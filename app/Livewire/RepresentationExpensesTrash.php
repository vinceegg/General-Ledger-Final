...
class RepresentationExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = RepresentationExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = RepresentationExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('RepresentationExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.representation-expenses-trash', [
