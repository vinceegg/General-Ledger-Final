...
class RepairsandMaintMachineryandEquipmentShow extends Component
{
    ...
    {       
        ...
        RepairsandMaintMachineryandEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = RepairsandMaintMachineryandEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        RepairsandMaintMachineryandEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new RepairsandMaintMachineryandEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new RepairsandMaintMachineryandEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = RepairsandMaintMachineryandEquipmentModel::query();
        ...
        $repairs_and_maint_machinery_and_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
