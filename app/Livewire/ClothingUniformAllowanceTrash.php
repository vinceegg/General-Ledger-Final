...
class ClothingUniformAllowanceTrash extends Component
{
    ...
    {
        $this->softDeletedData =ClothingUniformAllowanceModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = ClothingUniformAllowanceModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = ClothingUniformAllowanceModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('ClothingUniformAllowanceArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.clothing-uniform-allowance-trash', [
