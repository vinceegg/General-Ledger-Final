...
class GovernmentEquityShow extends Component
{
    ...
    {       
        ...
        GovernmentEquityModel::create($validatedData);
    ...
    {
        $general_ledger = GovernmentEquityModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        GovernmentEquityModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new GovernmentEquityExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new GovernmentEquityExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = GovernmentEquityModel::query();
        ...
        $government_equity = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.government-equity-show',['general_ledger' => $government_equity]);
    }
}
