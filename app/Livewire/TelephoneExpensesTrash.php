...
class TelephoneExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = TelephoneExpensesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = TelephoneExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('TelephoneExpensesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.telephone-expenses-trash', [
