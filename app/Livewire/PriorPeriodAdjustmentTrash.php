...
class PriorPeriodAdjustmentTrash extends Component
{
    ...
    {
        $this->softDeletedData = PriorPeriodAdjustmentModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = PriorPeriodAdjustmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('PriorPeriodAdjustmentArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.prior-period-adjustment-trash', [
