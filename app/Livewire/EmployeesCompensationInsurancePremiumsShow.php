...
class EmployeesCompensationInsurancePremiumsShow extends Component
{
    ...
    {       
        ...
        EmployeesCompensationInsurancePremiumsModel::create($validatedData);
    ...
    {
        $general_ledger = EmployeesCompensationInsurancePremiumsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        EmployeesCompensationInsurancePremiumsModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new EmployeesCompensationInsurancePremiumsImport, $filePath);

        return redirect()->route('EmployeesCompensationInsurancePremiums')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new EmployeesCompensationInsurancePremiumsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new EmployeesCompensationInsurancePremiumsExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = EmployeesCompensationInsurancePremiumsModel::query();
        ...
        $employees_compensation_insurance_premiums = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.employees-compensation-insurance-premiums-show',['general_ledger' => $employees_compensation_insurance_premiums]);
    }
}
