...
class MiscellaneousIncomeShow extends Component
{
    ...
    {       
        ...
        MiscellaneousIncomeModel::create($validatedData);
    ...
    {
        $general_ledger = MiscellaneousIncomeModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        MiscellaneousIncomeModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new MiscellaneousIncomeImport, $filePath);
    ...
    {
        return Excel::download(new MiscellaneousIncomeExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new MiscellaneousIncomeExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = MiscellaneousIncomeModel::query();
        ...
        $miscellaneous_income = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.miscellaneous-income-show',['general_ledger' => $miscellaneous_income]);
    }
}
