...
class AffiliationFeesTrash extends Component
{
    ...
    {
        $this->softDeletedData = AffiliationFeesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = AffiliationFeesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = AffiliationFeesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('AffiliationFeesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.affiliation-fees-trash', [
