...
class DuetoOfficersandEmployeesShow extends Component
{
    ...
    {       
        ...
        DuetoOfficersandEmployeesModel::create($validatedData);
    ...
    {
        $general_ledger = DuetoOfficersandEmployeesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        DuetoOfficersandEmployeesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new DuetoOfficersandEmployeesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DuetoOfficersandEmployeesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DuetoOfficersandEmployeesModel::query();
        ...
        $due_to_officers_and_employees = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.dueto-officersand-employees-show',['general_ledger' => $due_to_officers_and_employees]);
    }
}
