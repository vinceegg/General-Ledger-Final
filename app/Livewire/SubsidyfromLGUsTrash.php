...
class SubsidyfromLGUsTrash extends Component
{
    ...
    {
        $this->softDeletedData = SubsidyfromLGUsModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = SubsidyfromLGUsModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('SubsidyfromLGUsArchived')->with('message', 'Deleted Successfully');
    }
