...
class InfoandCommunicationTechnologyEquipmentShow extends Component
{
    ...
    {       
        ...
        InfoandCommunicationTechnologyEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = InfoandCommunicationTechnologyEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        InfoandCommunicationTechnologyEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new InfoandCommunicationTechnologyEquipmentImport, $filePath);

        return redirect()->route('InfoandCommunicationTechnologyEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new InfoandCommunicationTechnologyEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new InfoandCommunicationTechnologyEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = InfoandCommunicationTechnologyEquipmentModel::query();
        ...
        $info_and_communication_technology_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.infoand-communication-technology-equipment-show',['general_ledger' => $info_and_communication_technology_equipment]);
    }
}
