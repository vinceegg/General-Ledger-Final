...
class AccDepreciationDisasterResponseandRescueEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData = AccDepreciationDisasterResponseandRescueEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = AccDepreciationDisasterResponseandRescueEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = AccDepreciationDisasterResponseandRescueEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('AccDepreciationDisasterResponseandRescueEquipmentArchived')->with('message', 'Deleted Successfully');
    }
