...
class PersonnelEconomicReliefAllowanceShow extends Component
{
    ...
    {       
        ...
        PersonnelEconomicReliefAllowanceModel::create($validatedData);
    ...
    {
        $general_ledger = PersonnelEconomicReliefAllowanceModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        PersonnelEconomicReliefAllowanceModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new PersonnelEconomicReliefAllowanceExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new PersonnelEconomicReliefAllowanceExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = PersonnelEconomicReliefAllowanceModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $query = PersonnelEconomicReliefAllowanceModel::query();
        ...
        $personnel_economic_relief_allowance = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.personnel-economic-relief-allowance-show',['general_ledger' => $personnel_economic_relief_allowance]);
    }
}
