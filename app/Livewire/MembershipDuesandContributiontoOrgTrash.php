...
class MembershipDuesandContributiontoOrgTrash extends Component
{
    ...
    {
        $this->softDeletedData = MembershipDuesandContributiontoOrgModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = MembershipDuesandContributiontoOrgModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = MembershipDuesandContributiontoOrgModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('MembershipDuesandContributiontoOrgArchived')->with('message', 'Deleted Successfully');
    }
