...
class DepreciationFurnituresandBooksShow extends Component
{
    ...
    {       
        ...
        DepreciationFurnituresandBooksModel::create($validatedData);
    ...
    {
        $general_ledger = DepreciationFurnituresandBooksModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        DepreciationFurnituresandBooksModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new DepreciationFurnituresandBooksExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DepreciationFurnituresandBooksExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DepreciationFurnituresandBooksModel::query();
        ...
        $depreciation_furnitures_and_books = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.depreciation-furnituresand-books-show',['general_ledger' => $depreciation_furnitures_and_books]);
    }
}
