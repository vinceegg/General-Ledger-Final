...
class FuelOilandLubricantsExpensesTrash extends Component
{
    ...
    {
        $this->softDeletedData = FuelOilandLubricantsExpensesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = FuelOilandLubricantsExpensesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = FuelOilandLubricantsExpensesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('FuelOilandLubricantsExpensesArchived')->with('message', 'Deleted Successfully');
    }
