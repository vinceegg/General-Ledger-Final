...
class FurnitureandFixturesShow extends Component
{
    ...
    {       
        ...
        FurnitureandFixturesModel::create($validatedData);
    ...
    {
        $general_ledger = FurnitureandFixturesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        FurnitureandFixturesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new FurnitureandFixturesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new FurnitureandFixturesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = FurnitureandFixturesModel::query();
        ...
        $furniture_and_fixtures = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.furnitureand-fixtures-show',['general_ledger' => $furniture_and_fixtures]);
    }
}
