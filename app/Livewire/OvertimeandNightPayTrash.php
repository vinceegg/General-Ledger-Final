...
class OvertimeandNightPayTrash extends Component
{
    ...
    {
        $this->softDeletedData =OvertimeandNightPayModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = OvertimeandNightPayModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OvertimeandNightPayArchived')->with('message', 'Deleted Successfully');
    }
