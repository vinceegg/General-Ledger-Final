...
class InterestIncomeShow extends Component
{
    ...
    {       
        ...
        InterestIncomeModel::create($validatedData);
    ...
    {
        $general_ledger = InterestIncomeModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        InterestIncomeModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new InterestIncomeExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new InterestIncomeExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = InterestIncomeModel::query();
        ...
        $interest_income = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.interest-income-show',['general_ledger' => $interest_income]);
    }
}
