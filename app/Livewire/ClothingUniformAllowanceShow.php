...
class ClothingUniformAllowanceShow extends Component
{
    ...
    {       
        ...
        ClothingUniformAllowanceModel::create($validatedData);
    ...
    {
        $general_ledger = ClothingUniformAllowanceModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        ClothingUniformAllowanceModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new ClothingUniformAllowanceImport, $filePath);

        return redirect()->route('ClothingUniformAllowance')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new ClothingUniformAllowanceExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new ClothingUniformAllowanceExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = ClothingUniformAllowanceModel::query();
        ...
        return view('livewire.clothing-uniform-allowance-show',['general_ledger' => $general_ledger]);
    }
}
