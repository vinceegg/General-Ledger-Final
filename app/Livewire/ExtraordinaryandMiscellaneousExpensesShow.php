...
class ExtraordinaryandMiscellaneousExpensesShow extends Component
{
    ...
    {       
        ...
        ExtraordinaryandMiscellaneousExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = ExtraordinaryandMiscellaneousExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        ExtraordinaryandMiscellaneousExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new ExtraordinaryandMiscellaneousExpensesImport, $filePath);

        return redirect()->route('ExtraordinaryandMiscellaneousExpenses')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new ExtraordinaryandMiscellaneousExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new ExtraordinaryandMiscellaneousExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = ExtraordinaryandMiscellaneousExpensesModel::query();
        ...
        $extraordinary_and_miscellaneous_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.extraordinaryand-miscellaneous-expenses-show',['general_ledger' => $extraordinary_and_miscellaneous_expenses]);
    }
}
