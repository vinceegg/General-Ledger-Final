...
class LongetivityPayShow extends Component
{
    ...
    {       
        ...
        LongetivityPayModel::create($validatedData);
    ...
    {
        $general_ledger = LongetivityPayModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        LongetivityPayModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new LongetivityPayImport, $filePath);

        return redirect()->route('LongetivityPay')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new LongetivityPayExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new LongetivityPayExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = LongetivityPayModel::query();
        ...
        $longetivity_pay = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.longetivity-pay-show',['general_ledger' => $longetivity_pay]);
    }
}
