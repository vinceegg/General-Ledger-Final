...
class MiscellaneousIncomeTrash extends Component
{
    ...
    {
        $this->softDeletedData =MiscellaneousIncomeModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = MiscellaneousIncomeModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = MiscellaneousIncomeModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('MiscellaneousIncomeArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.miscellaneous-income-trash', [
