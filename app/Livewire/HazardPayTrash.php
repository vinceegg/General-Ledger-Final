...
class HazardPayTrash extends Component
{
    ...
    {
        $this->softDeletedData =HazardPayModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = HazardPayModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = HazardPayModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('HazardPayArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.hazard-pay-trash', [
