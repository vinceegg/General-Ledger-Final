...
class SubsidyfromLGUsShow extends Component
{
    ...
    {       
        ...
        SubsidyfromLGUsModel::create($validatedData);
    ...
    {
        $general_ledger = SubsidyfromLGUsModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        SubsidyfromLGUsModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new SubsidyfromLGUsExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new SubsidyfromLGUsExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = SubsidyfromLGUsModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $query = SubsidyfromLGUsModel::query();
        ...
        $subsidy_from_lgus = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.subsidy-from-lgus-show',['general_ledger' => $subsidy_from_lgus]);
    }
}
