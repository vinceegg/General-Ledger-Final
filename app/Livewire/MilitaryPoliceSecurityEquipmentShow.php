...
class MilitaryPoliceSecurityEquipmentShow extends Component
{
    ...
    {       
        ...
        MilitaryPoliceSecurityEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger = MilitaryPoliceSecurityEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        MilitaryPoliceSecurityEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new MilitaryPoliceSecurityEquipmentImport, $filePath);

        return redirect()->route('MilitaryPoliceSecurityEquipment')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new MilitaryPoliceSecurityEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new MilitaryPoliceSecurityEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = MilitaryPoliceSecurityEquipmentModel::query();
        ...
        $military_police_security_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.military-police-security-equipment-show',['general_ledger' => $military_police_security_equipment]);
    }
}
