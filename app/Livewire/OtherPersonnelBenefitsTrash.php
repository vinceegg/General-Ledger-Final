...
class OtherPersonnelBenefitsTrash extends Component
{
    ...
    {
        $this->softDeletedData = OtherPersonnelBenefitsModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OtherPersonnelBenefitsModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OtherPersonnelBenefitsModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OtherPersonnelBenefitsArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.other-personnel-benefits-trash', [
