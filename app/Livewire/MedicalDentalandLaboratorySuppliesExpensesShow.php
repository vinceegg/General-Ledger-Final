...
class MedicalDentalandLaboratorySuppliesExpensesShow extends Component
{
    ...
    {       
        ...
        MedicalDentalandLaboratorySuppliesExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = MedicalDentalandLaboratorySuppliesExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        MedicalDentalandLaboratorySuppliesExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new MedicalDentalandLaboratorySuppliesExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new MedicalDentalandLaboratorySuppliesExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = MedicalDentalandLaboratorySuppliesExpensesModel::query();
        ...
        $medical_dental_and_laboratory_supplies_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.medical-dentaland-laboratory-supplies-expenses-show',['general_ledger' => $medical_dental_and_laboratory_supplies_expenses]);
    }
}
