...
class RetirementandLifeInsurancePremiumsTrash extends Component
{
    ...
    {
        $this->softDeletedData = RetirementandLifeInsurancePremiumsModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = RetirementandLifeInsurancePremiumsModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('RetirementandLifeInsurancePremiumsArchived')->with('message', 'Deleted Successfully');
    }
