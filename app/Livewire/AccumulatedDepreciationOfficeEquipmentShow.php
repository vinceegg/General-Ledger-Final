...
class AccumulatedDepreciationOfficeEquipmentShow extends Component
{
    ...
    {
        return Excel::download(new AccumulatedDepreciationOfficeEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccumulatedDepreciationOfficeEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    public function render()
    {
        ...
        $accumulated_depreciation_office_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.accumulated-depreciation-office-equipment-show',['general_ledger' => $accumulated_depreciation_office_equipment]);
    }
}
