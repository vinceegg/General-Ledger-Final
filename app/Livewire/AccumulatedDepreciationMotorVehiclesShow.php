...
class AccumulatedDepreciationMotorVehiclesShow extends Component
{
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new AccumulatedDepreciationMotorVehiclesImport, $filePath);

        return redirect()->route('AccumulatedDepreciationMotorVehicles')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new AccumulatedDepreciationMotorVehiclesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccumulatedDepreciationMotorVehiclesExport, 'Ledger Sheet.csv');
    }
    ...
    public function render()
    {
        ...
        $accumulated_depreciation_motor_vehicles = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.accumulated-depreciation-motor-vehicles-show',['general_ledger' => $accumulated_depreciation_motor_vehicles]);
    }
}
