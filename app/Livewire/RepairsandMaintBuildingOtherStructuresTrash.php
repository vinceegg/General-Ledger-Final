...
class RepairsandMaintBuildingOtherStructuresTrash extends Component
{
    ...
    {
        $this->softDeletedData = RepairsandMaintBuildingOtherStructuresModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = RepairsandMaintBuildingOtherStructuresModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('RepairsandMaintBuildingOtherStructuresArchived')->with('message', 'Deleted Successfully');
    }
