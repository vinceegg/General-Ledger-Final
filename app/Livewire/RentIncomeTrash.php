...
class RentIncomeTrash extends Component
{
    ...
    {
        $this->softDeletedData = RentIncomeModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = RentIncomeModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('RentIncomeArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.rent-income-trash', [
