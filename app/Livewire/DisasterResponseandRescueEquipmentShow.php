...
use App\Exports\DisasterResponseandRescueEquipmenExport;
...
class DisasterResponseandRescueEquipmentShow extends Component
{
    ...
    {       
        ...
        DisasterResponseandRescueEquipmentModel::create($validatedData);
    ...
    public function updateGeneralLedger()
    {
        ...
        DisasterResponseandRescueEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new DisasterResponseandRescueEquipmenExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new DisasterResponseandRescueEquipmenExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = DisasterResponseandRescueEquipmentModel::query();
        ...
        $disaster_response_and_rescue_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.disaster-responseand-rescue-equipment-show',['general_ledger' => $disaster_response_and_rescue_equipment]);
    }
}
