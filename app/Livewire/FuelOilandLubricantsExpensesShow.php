...
class FuelOilandLubricantsExpensesShow extends Component
{
    ...
    {       
        ...
        FuelOilandLubricantsExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = FuelOilandLubricantsExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        FuelOilandLubricantsExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new FuelOilandLubricantsExpensesImport, $filePath);

        return redirect()->route('FuelOilandLubricantsExpenses')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new FuelOilandLubricantsExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new FuelOilandLubricantsExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = FuelOilandLubricantsExpensesModel::query();
        ...
        $fuel_oil_and_lubricants_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.fuel-oiland-lubricants-expenses-show',['general_ledger' => $fuel_oil_and_lubricants_expenses]);
    }
}
