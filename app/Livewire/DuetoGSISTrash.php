...
class DuetoGSISTrash extends Component
{
    ...
    {
        $this->softDeletedData = DuetoGSISModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DuetoGSISModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DuetoGSISModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DuetoGSISArchived')->with('message', 'Deleted Successfully');
    }
