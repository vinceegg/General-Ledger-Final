...
class OtherBusinessIncomeShow extends Component
{
    ...
    {       
        ...
        OtherBusinessIncomeModel::create($validatedData);
    ...
    {
        $general_ledger = OtherBusinessIncomeModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OtherBusinessIncomeModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new OtherBusinessIncomeExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OtherBusinessIncomeExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OtherBusinessIncomeModel::query();
        ...
        $other_business_income = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.other-business-income-show',['general_ledger' => $other_business_income]);
    }
}
