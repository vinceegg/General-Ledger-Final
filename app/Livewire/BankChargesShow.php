...
class BankChargesShow extends Component
{
    ...
    {       
        ...
        BankChargesModel::create($validatedData);
    ...
    {
        $general_ledger = BankChargesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        BankChargesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new BankChargesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new BankChargesExport, 'Ledger Sheet.csv');
    }
    ...
    public function render()
    {
        ...
        $bank_charges = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.bank-charges-show',['general_ledger' => $bank_charges]);
    }
}
