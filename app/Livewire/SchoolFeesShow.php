...
class SchoolFeesShow extends Component
{
    ...
    {       
        ...
        SchoolFeesModel::create($validatedData);
    ...
    {
        $general_ledger = SchoolFeesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        SchoolFeesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new SchoolFeesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new SchoolFeesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = SchoolFeesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    public function render()
    {
        ...
        $school_fees = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.school-fees-show',['general_ledger' => $school_fees]);
    }
}
