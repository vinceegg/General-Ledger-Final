...
class DisasterResponseandRescueEquipmentTrash extends Component
{
    ...
    {
        $this->softDeletedData =DisasterResponseandRescueEquipmentModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DisasterResponseandRescueEquipmentModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DisasterResponseandRescueEquipmentModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DisasterResponseandRescueEquipmentArchived')->with('message', 'Deleted Successfully');
    }
