...
class SchoolFeesTrash extends Component
{
    ...
    {
        $this->softDeletedData = SchoolFeesModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = SchoolFeesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('SchoolFeesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.school-fees-trash', [
