...
class GrantsDonationsinKindTrash extends Component
{
    ...
    {
        $this->softDeletedData =GrantsDonationsinKindModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = GrantsDonationsinKindModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = GrantsDonationsinKindModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('GrantsDonationsinKindArchived')->with('message', 'Deleted Successfully');
    }
