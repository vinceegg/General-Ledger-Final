...
class GovernmentEquityTrash extends Component
{
    ...
    {
        $this->softDeletedData = GovernmentEquityModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = GovernmentEquityModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = GovernmentEquityModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('GovernmentEquityArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.government-equity-trash', [
