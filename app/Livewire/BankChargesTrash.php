...
class BankChargesTrash extends Component
{
    ...
    {
        $this->softDeletedData = BankChargesModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = BankChargesModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = BankChargesModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('BankChargesArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.bank-charges-trash', [
