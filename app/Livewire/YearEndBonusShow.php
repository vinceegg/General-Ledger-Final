...
class YearEndBonusShow extends Component
{
    ...
    {       
        ...
        YearEndBonusModel::create($validatedData);
    ...
    {
        $general_ledger = YearEndBonusModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        YearEndBonusModel::where('id', $this->general_ledger_id)->update([
    ...
    // Ensure that a file has been uploaded
        ...
        Excel::import(new YearEndBonusImport, $filePath);

        return redirect()->route('YearEndBonus')->with('message', 'File Imported Successfully');
        }
    }
    ...
    {
        return Excel::download(new YearEndBonusExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new YearEndBonusExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $general_ledger = YearEndBonusModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    public function render()
    {
        ...
        return view('livewire.year-end-bonus-show',['general_ledger' => $general_ledger]);
    }
}