...
class PagibigContributionsTrash extends Component
{
    ...
    {
        $this->softDeletedData = PagibigContributionsModel::onlyTrashed()->get();
    }
    ...
    {
        $general_ledger = PagibigContributionsModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('PagibigContributionsArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.pagibig-contributions-trash', [
