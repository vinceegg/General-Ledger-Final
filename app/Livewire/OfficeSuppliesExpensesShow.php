...
class OfficeSuppliesExpensesShow extends Component
{
    ...
    {       
        ...
        OfficeSuppliesExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = OfficeSuppliesExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        OfficeSuppliesExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new OfficeSuppliesExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new OfficeSuppliesExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = OfficeSuppliesExpensesModel::query();
        ...
        $office_supplies_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.office-supplies-expenses-show',['general_ledger' => $office_supplies_expenses]);
    }
}
