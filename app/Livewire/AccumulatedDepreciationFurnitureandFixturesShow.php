...
class AccumulatedDepreciationFurnitureandFixturesShow extends Component
{
    ...
    {       
        ...
        AccumulatedDepreciationFurnitureandFixturesModel::create($validatedData);
    ...
    {
        $general_ledger = AccumulatedDepreciationFurnitureandFixturesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccumulatedDepreciationFurnitureandFixturesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new AccumulatedDepreciationFurnitureandFixturesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccumulatedDepreciationFurnitureandFixturesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query =AccumulatedDepreciationFurnitureandFixturesModel::query();
        ...
        $accumulated_depreciation_furniture_and_fixtures = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.accumulated-depreciation-furnitureand-fixtures-show',['general_ledger' => $accumulated_depreciation_furniture_and_fixtures]);
    }
}
