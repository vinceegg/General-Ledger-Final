...
class AccumulatedDepreciationICTEquipmentShow extends Component
{
    ...
    {       
        ...
        AccumulatedDepreciationICTEquipmentModel::create($validatedData);
    ...
    {
        $general_ledger =AccumulatedDepreciationICTEquipmentModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        AccumulatedDepreciationICTEquipmentModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new AccumulatedDepreciationICTEquipmentExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new AccumulatedDepreciationICTEquipmentExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = AccumulatedDepreciationICTEquipmentModel::query();
        ...
        $accumulated_depreciation_ict_equipment = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
