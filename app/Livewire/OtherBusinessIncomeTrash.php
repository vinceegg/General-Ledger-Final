...
class OtherBusinessIncomeTrash extends Component
{
    ...
    {
        $this->softDeletedData = OtherBusinessIncomeModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = OtherBusinessIncomeModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = OtherBusinessIncomeModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('OtherBusinessIncomeArchived')->with('message', 'Deleted Successfully');
    }
    ...
    {
        return view('livewire.other-business-income-trash', [
