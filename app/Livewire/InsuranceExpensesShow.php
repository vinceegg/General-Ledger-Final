...
class InsuranceExpensesShow extends Component
{
    ...
    {       
        ...
        InsuranceExpensesModel::create($validatedData);
    ...
    {
        $general_ledger = InsuranceExpensesModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        InsuranceExpensesModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new InsuranceExpensesExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new InsuranceExpensesExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = InsuranceExpensesModel::query();
        ...
        $insurance_expenses = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.insurance-expenses-show',['general_ledger' => $insurance_expenses]);
    }
}
