...
class DepreciationBuildingandStructuresTrash extends Component
{
    ...
    {
        $this->softDeletedData = DepreciationBuildingandStructuresModel::onlyTrashed()->get();
    }

    // Method to restore soft-deleted record
    public function restoreGeneralLedger($id)
    {
        $general_ledger = DepreciationBuildingandStructuresModel::onlyTrashed()->find($id);
        if ($general_ledger) {
    ...
    {
        $general_ledger = DepreciationBuildingandStructuresModel::withTrashed()->find($this->general_ledger_id);
        ...
        $this->resetInput();
        return redirect()->route('DepreciationBuildingandStructuresArchived')->with('message', 'Deleted Successfully');
    }
