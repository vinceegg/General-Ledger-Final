...
class BuildingsandOtherStructuresShow extends Component
{
    ...
    {       
        ...
        BuildingsandOtherStructuresModel::create($validatedData);
    ...
    {
        $general_ledger = BuildingsandOtherStructuresModel::find($general_ledger_id);
        if ($general_ledger) {
    ...
    public function updateGeneralLedger()
    {
        ...
        BuildingsandOtherStructuresModel::where('id', $this->general_ledger_id)->update([
    ...
    {
        return Excel::download(new BuildingsandOtherStructuresExport, 'Ledger Sheet.xlsx');
    }
    public function exportGl_CSV(Request $request) 
    {
        return Excel::download(new BuildingsandOtherStructuresExport, 'Ledger Sheet.csv');
    }
    ...
    {
        $query = BuildingsandOtherStructuresModel::query();
        ...
        $buildings_and_other_structures = $query->orderBy('id', 'ASC')->get(); // Changed from paginate() to get()
        ...
        return view('livewire.buildingsand-other-structures-show',['general_ledger' => $buildings_and_other_structures]);
    }
}
