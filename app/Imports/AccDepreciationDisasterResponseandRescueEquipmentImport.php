...
class AccDepreciationDisasterResponseandRescueEquipmentImport implements ToModel, WithHeadingRow
{
    /**
    ...
    */
    ...
    {
        return new AccDepreciationDisasterResponseandRescueEquipmentModel([
            'gl_date'               => $row['date'],
