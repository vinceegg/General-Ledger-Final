...
return new class extends Migration
{
    ...
    {
        Schema::create('accumulated_depreciation_furniture_and_fixtures', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('accumulated_depreciation_furniture_and_fixtures');
    }
};
