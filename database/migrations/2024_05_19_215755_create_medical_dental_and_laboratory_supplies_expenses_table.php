...
return new class extends Migration
{
    ...
    {
        Schema::create('medical_dental_and_laboratory_supplies_expenses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('medical_dental_and_laboratory_supplies_expenses');
    }
};
