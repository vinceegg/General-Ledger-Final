...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_depreciation_military_police_security_eqpmnt', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('acc_depreciation_military_police_security_eqpmnt');
    }
};
