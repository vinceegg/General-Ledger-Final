...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_depreciation_disaster_response_and_rescue_equipment', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('acc_depreciation_disaster_response_and_rescue_equipment');
    }
};
