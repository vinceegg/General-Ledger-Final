...
return new class extends Migration
{
    ...
    {
        Schema::create('acc_depreciation_technical_scientific_equipment', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('acc_depreciation_technical_scientific_equipment');
    }
};
