        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 fixed w-full max-w-2xl bg-white dark:bg-gray-700 z-10">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">
                    Add New Check Disbursement Journal Entry
                </h3>
            ...
            <div class="p-4 pt-20 pb-16 mb-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-y-auto max-h-[calc(100vh-160px)]">
                <!-- Function for adding -->    
                <form wire:submit.prevent="saveCheckDisbursementJournal" x-data>
                    <!-- Modal content -->
                    <div class="grid gap-4 p-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                <text class="font-base font-bold">Check Disbursement Journal Information</text>
                                ...
                                <div class="grid gap-4 grid-cols-2">
                                    <div class="col-span-1">
                                        ...
                                        <input type="date" wire:model="ckdj_entrynum_date" class="mb-2 w-full bg-gray-50 border {{ $errors->has('ckdj_entrynum_date') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                                        @error('ckdj_entrynum_date') <span class="text-red-500">{{ $message }}</span> @enderror
                                    </div>
                                ...
                                <div class="col-span-2">
                                    <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Payee</label>
                                    <textarea class="block mb-2 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border {{ $errors->has('ckdj_payee') ? 'border-red-500' : 'border-gray-300' }} focus:ring-blue-500 focus:border-blue-500" id="description" 
                                    rows="2" wire:model="ckdj_payee"></textarea>
                                    @error('ckdj_payee') <span class="text-red-500">{{ $message }}</span> @enderror
                                </div>

                                <div class="col-span-2">
                                    <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">B.U.R. No.</label>
                                    <input type="text" wire:model="ckdj_bur" class="mb-2 bg-gray-50 border {{ $errors->has('ckdj_bur') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" 
                                    placeholder="YYYY-MM-BUR Number">
                                    @error('ckdj_bur') <span class="text-red-500">{{ $message }}</span> @enderror
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                ...
                                <div class="grid gap-4 grid-cols-3">
                                    <div class="col-span-3">
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">CIB-LCCA</label>
                                        <input type="number" step="any" wire:model="ckdj_cib_lcca" class=" w-full bg-gray-50 border {{ $errors->has('ckdj_cib_lcca') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        placeholder="₱">
                                        @error('ckdj_cib_lcca') <span class="text-red-500">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="col-span-1">
                                        <text class="text-sm text-gray-900">Witholding Tax</text>
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">2-02-01-010-A</label>
                                        <input type="number" step="any" wire:model="ckdj_account1" class="mb-2 w-full bg-gray-50 border {{ $errors->has('ckdj_account1') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" 
                                        placeholder="₱">
                                        @error('ckdj_account1') <span class="text-red-500">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="col-span-1">
                                        <text class="text-sm text-gray-900">Witholding Tax</text>
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">2-02-01-010-A</label>
                                        <input type="number" step="any" wire:model="ckdj_account2" class="mb-2 w-full bg-gray-50 border {{ $errors->has('ckdj_account2') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" 
                                        placeholder="₱">
                                        @error('ckdj_account2') <span class="text-red-500">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="col-span-1">
                                        <text class="text-sm text-gray-900">Witholding Tax</text>
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">2-02-01-010-A</label>
                                        <input type="number" step="any" wire:model="ckdj_account3" class="mb-2 w-full bg-gray-50 border {{ $errors->has('ckdj_account3') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" 
                                        placeholder="₱">
                        ...
                        <div class="col-span-2">
                            <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                <text class="font-base font-bold">Debit</text>
                                <hr class="my-4 w-full border-t border-gray-300">

                                <div class="grid gap-4 grid-cols-2">
                                    <div class="col-span-1">
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">SAL & Wages</label>
                                        <input type="number" step="any" wire:model="ckdj_salary_wages"  class="mb-2 w-full bg-gray-50 border {{ $errors->has('ckdj_salary_wages') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        placeholder="₱">
                                        @error('ckdj_salary_wages') <span class="text-red-500">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="col-span-1">
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Honoraria</label>
                                        <input type="number" step="any" wire:model="ckdj_honoraria" class="mb-2 w-full bg-gray-50 border {{ $errors->has('ckdj_honoraria') ? 'border-red-500' : 'border-gray-300 text-gray-900' }} rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        placeholder="₱">
                                        @error('ckdj_honoraria') <span class="text-red-500">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                            </div>
                        </div>           
                            ...
                            <div class="col-span-2">
                                <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                    ...
                                    <div class="grid gap-4"> <!-- Account code input field with typeahead logic ni ate korin-->
                                            <div class="col-span-2" x-data="{ code: @entangle('ckdj_sundry_data.' . $index . '.ckdj_accountcode') }">
                                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Account Code</label>
                                                            <select wire:model="ckdj_sundry_data.{{ $index }}.ckdj_accountcode" class="bg-gray-50 border {{ $errors->has('ckdj_sundry_data.' . $index . '.ckdj_accountcode') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">                     
                                            ...
                                            <div class ="col-span-2 sm:col-span-1">
                                                ...
                                                <input type="number" step="any" wire:model="ckdj_sundry_data.{{ $index }}.ckdj_debit"  class="bg-gray-50 border 
                                                {{ $errors->has('ckdj_sundry_data.' . $index . '.ckdj_debit') ? 'border-red-500 ' : 'border-gray-300' }} border-gray-300 text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " 
                                                placeholder="₱">
                                                @error('ckdj_sundry_data.' . $index . '.ckdj_debit') <span class="text-red-500">{{ $message }}</span> @enderror
                                            </div>
                                            
                                            <div class="col-span-2 sm:col-span-1">
                                                <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Credit</label>
                                                <input type="number" step="any" wire:model="ckdj_sundry_data.{{ $index }}.ckdj_credit" class="bg-gray-50 border 
                    ...
                    <div class="absolute bottom-0 left-0 w-full bg-white dark:bg-gray-700 rounded-b">
                        <div class="flex justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 max-w-2xl mx-auto">
                            ...
                            <div class="flex justify-end">
                                ...
                                {{-- <button type="submit" @keydown.enter.prevent="$wire.saveCheckDisbursementJournal()" class="text-white inline-flex items-center bg-blue-800 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 text-center" style="font-weight: bold;">
                                    Add Transaction
                                </button> --}}
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" x-data="{ exportFormat: 'xlsx' }">
                    ...
                    <div class="col-span-2 flex justify-end mr-2 mt-4">            
                        ...
                        wire:click="exportCKDJ_CSV" x-show="exportFormat === 'csv'">Export</button>
                        ...
                        wire:click="exportCKDJ_XLSX" x-show="exportFormat === 'xlsx'">Export</button>
                    </div>
                </div>
            </form>
        </div>
