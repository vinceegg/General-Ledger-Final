                    ...
                    <div class="grid gap-4 p-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                <span class="font-base font-bold">Cash Disbursement Journal Information</span>
                        ...
                        <div class="col-span-2">
                            <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                <span class="font-base font-bold">Credit</span>
                                <hr class="my-4 w-full border-t border-gray-300">
                                ...
                                <div class="grid gap-4"> <!-- Account code input field with typeahead logic ni ate korin-->
                                    <div class="col-span-2" x-data="{ 
                                        ...
                                        filteredItems: [],
                                        filterItems() {
                                            this.filteredItems = this.items.filter(item => item.toLowerCase().includes(this.code.toLowerCase()));
                                        },
                                        setInputValue(value) {
                                            this.code = value;
                                            this.filteredItems = [];
                                        ...
                                        <select wire:model="cdj_credit_accountcode" class="bg-gray-50 border {{ $errors->has('cdj_credit_accountcode') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"> 
                                        ...
                                        <div class="relative">
                                            <ul class="text-gray-700 mt-1 w-full border-2 shadow-xl rounded-lg absolute bg-white cursor-pointer focus:outline-none" x-show="filteredItems.length > 0" @click.away="clearSuggestions">
                                                <template x-for="(item, index) in filteredItems" :key="item">
                                                    <li class="p-2 border-t border-gray-200 hover:bg-gray-50" @click="setInputValue(item)">
                        ...
                        <div class="col-span-2">
                            <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                <div class="col-span-2 sm:col-span-1 items-center flex justify-between"> <!-- Title, X button, divider -->
                                    <div>
                                        <span class="font-base font-bold ">Sundry</span>
                                    </div>
                                    <div>
                                ...
                                <div class="grid gap-4">
                                    <div class="col-span-3" x-data="{ 
                                        ...
                                        <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Account Code</label>
                                        <select wire:model="cdj_sundry_data.{{ $index }}.cdj_sundry_accountcode" class="bg-gray-50 border {{ $errors->has('cdj_sundry_data.' . $index . '.cdj_sundry_accountcode') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                                            <option value="">Select account code</option>
                                            <option value="">Select account code</option>
                                        <option value="1 01 01 010 - Cash Local Treasury">1 01 01 010 - Cash Local Treasury</option>
                                        <option value="1 01 01 020 - Petty Cash">1 01 01 020 - Petty Cash</option>
                        ...
                        <!-- Add sundry button -->
                        <div class="col-span-2">
                            <button type="button" class="cursor-pointer border border-gray-300 mr-2 text-black w-full inline-flex items-center hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-base px-5 py-2.5 text-center"
