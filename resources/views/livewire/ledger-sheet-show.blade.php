              ...
              <div class="bg-white rounded-lg">
                ...
                <div class="flex flex-wrap md:justify-end">
                                             ...
                                             <div x-data="{ open: false }" class="relative inline-block text-left">
                                                ...
                                                <!-- Save Button -->
                                              <a href="{{ route('LedgerSheetArchived') }}" class="relative group border-none bg-none rounded-lg px-3 py-2.5 text-center inline-flex items-center">
                                              ...
                                              <!-- Archive button -->
                                              <a href="{{ route('LedgerSheetArchived') }}" class="relative group rounded-lg px-3 py-2.5 text-center inline-flex items-center">
