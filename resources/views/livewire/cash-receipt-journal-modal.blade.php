                                ...
                                <div class="bg-white border border-gray-300 rounded-lg p-4"> <!-- Outer Rectangle -->
                                    ...
                                    <hr class="my-4 w-full border-t border-gray-300">    
                                        <div class="grid gap-4"> <!-- Account code input field with typeahead logic ni ate korin-->
                                            <div class="col-span-2" x-data="{ code: @entangle('crj_sundry_data.' . $index . '.crj_accountcode') }">
                                                            <label class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Account Code</label>
                                                            <select wire:model="crj_sundry_data.{{ $index }}.crj_accountcode" class="bg-gray-50 border {{ $errors->has('gj_accountcodes_data.' . $index . '.gj_accountcode') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">                     
