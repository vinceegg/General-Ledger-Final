      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="dropdown-example" class="py-2 space-y-2">
                  ...
                  <li>
                  @foreach(['GJ'] as $route)
                     <a href="{{ url('/' . $route) }}" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group group bg-blue-700  dark:text-white dark:hover:bg-gray-700">General Journal</a>
                  @endforeach
                    </li>
            </ul>
         </li>
...
>>>>>>> 5b8ab7c14a0e92cafa16eec3f12d03de2ebc0e4c
         <li>
